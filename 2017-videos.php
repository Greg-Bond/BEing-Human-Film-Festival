    ...
    if ($counter == 0)
    {
        ...
        <div class="carousel-item col-md-4 p-4 active" id="'.$videoInfo.'">
            ...
            onclick="getInfo(\''.$videoInfo.'\');"  >
                <img class="img-fluid mx-auto d-block" src="content/images/2017Video/'.$videoImage.'" />
            </a>
...
<body class="videos">
    ...
    <nav class="navbar navbar-expand-lg navbar-toggleable-md fixed-top">
        <div class="container">
            <!--Logo-->
            <a href="index.html" class="navbar-brand mx-auto my-1"><img class="logo"  src="content/images/BHFFlogo.png"/></a>
            <!--Nav Menu-->
            <div class="collapse navbar-collapse justify-content-center" id="nav-menu">
                <ul class="navbar-nav">
                    ...
                    <li class="dropdown d-none d-lg-block d-xl-block"><!--Dropdown menu-->
                        <a class="px-3 py-2 nav-link dropdown-toggle" href="2018-videos.html" data-toggle="dropdown">Videos</a>
                        <div class="dropdown-menu m-0">
                            <a class="dropdown-item" href="2017-videos.html">2017 Videos</a>
                        </div>
                    </li>
                    <li class="d-lg-none d-xl-none "><!--Dropdown menu when collapsed-->
                        <a class="navbar-item px-3 nav-link" href="2018-videos.html">Videos</a>
                        <ul class="nav-list">
                            <li class="navbar-item"><a class="nav-link active" href="2017-videos.html">2017 Videos</a></li>
                        </ul>
                    </li>
                    <li class="navbar-item">
                        <a class="nav-link px-3 py-2" href="news.html">News</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container-fluid col-10 col-md-9 col-lg-8 page-contents p-4">
        ...
        <!--Carousel-->
        <div id="video-carousel" class="row mx-1 carousel slide" data-ride="carousel">
    ...
    <footer id="footer">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-2 cols">
                    <h5><a class="footer-heading" href="index.html">BEing Human Film Festival</a></h5>
                    <ul>
                ...
                <div class="col-sm-2 cols">
                    <h5><a class="footer-heading" href="2018-videos.html">Videos</a></h5>
                    <ul>
                        <li><a href="2018-videos.html">BHFF Entries 2018</a></li>
                        <li><a href="2017-videos.html">BHFF Entries 2017</a></li>
                    </ul>
                </div>
                <div class="col-sm-2 cols">
                    <h5><a class="footer-heading" href="charities.html">Charities</a></h5>
                    <ul>
                        <li><a href="#">108 Lives Project</a></li>
				...
				<div class="col-sm-3 cols">
                    ...
                    <ul>
                        <li><a href="http://www.jmcacademy.edu.au/">JMC Academy</a></li>
                        <li><a href="http://www.sydneyshortfilmschool.com/">Sydney Short Film School</a></li>
                        <li><a href="https://canterbury.ljhooker.com.au/">LJ Hooker Canterbury</a></li>
						<li><a href="https://www.greenavenue.com.au/">Green Avenue Design</a></li>
						<li><a href="https://www.dendy.com.au/">Dendy Cinemas</a></li>
                        <li><a href="https://www.palacecinemas.com.au/">Palace Cinemas</a></li>
                        <li><a href="#">Da Vinci Restaurant Summer Hill</a></li>
					</ul>
                </div>
		...
		<div class="container-fluid">
            <div class="row">
				...
				<div class="col-sm-2 cols">
                    <ul>
                        <h5><li><a class="footer-heading" href="#">Judges Login</a></li></h5>
                        <h5><li><a class="footer-heading" href="#">Admin Login</a></li></h5>
                     </ul>
					</div>
				<div class="col-sm-2 cols">
                </div>
				...
				<div class="social-networks">
					<a href="#"><img class="footer-icon" src="content/images/Youtube_circle_bw.png"></a>
					<a href="#"><img class="footer-icon" src="content/images/Facebook_circle_bw.png"></a>
					<a href="#"><img class="footer-icon" src="content/images/Instagram_circle_bw.png"></a>
					<a href="#"><img class="footer-icon" src="content/images/Twitter_circle_bw.png"></a>
